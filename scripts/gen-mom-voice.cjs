...
//
// Voice: zh-TW-HsiaoChenNeural — a 50s/60s Taiwanese female neural voice that
// matches the script's "exasperated but loving Taipei mom" brief better than
// the higher-pitched HsiaoYu. Slight rate slowdown + pitch drop sells the
// "scolding" tone for missed runs; "caught" runs play it warmer.
//
...
const LINES = [
  { day: 1, outcome: 'caught',  text: '你看，沒那麼難吧。',                        rate: '-5%',  pitch: '-2Hz'  },
  { day: 1, outcome: 'missed',  text: '才第一天？',                                 rate: '-8%',  pitch: '-6Hz'  },
  { day: 2, outcome: 'caught',  text: '表現不錯，飯快好了。',                       rate: '-5%',  pitch: '-2Hz'  },
  { day: 2, outcome: 'missed',  text: '跟你說了兩包，廚房現在都臭了。',             rate: '-10%', pitch: '-8Hz'  },
  { day: 3, outcome: 'caught',  text: '淋濕了但有趕上，去換襪子。',                 rate: '-5%',  pitch: '-2Hz'  },
  { day: 3, outcome: 'missed',  text: '下雨，當然被你錯過了。',                     rate: '-10%', pitch: '-8Hz'  },
  { day: 4, outcome: 'caught',  text: '在夜市那邊還聽得到，今晚耳朵夠尖。',         rate: '-5%',  pitch: '-2Hz'  },
  { day: 4, outcome: 'missed',  text: '只顧著看鹹酥雞排隊是不是？',                 rate: '-8%',  pitch: '-8Hz'  },
  { day: 5, outcome: 'caught',  text: '一整個禮拜，還不錯，來吃飯。',               rate: '-5%',  pitch: '-2Hz'  },
  { day: 5, outcome: 'missed',  text: '最後一天⋯⋯那些舊衣服我放好幾個禮拜了。',    rate: '-12%', pitch: '-10Hz' },
];
